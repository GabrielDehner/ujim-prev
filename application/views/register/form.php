<div class="container mb-3 mt-3">
    <h3>Registrate para participar en la conferencia!</h3>
    ...
    <form id="form">
        ...
        <div class="form-group" >
            ...
            <div class="form-row">
                <div class="col">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="assistance9" value="2018" name="assistance">
                        <label class="form-check-label" for="assistance9">2018</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="assistance10" value="2019" name="assistance">
                        <label class="form-check-label" for="assistance9">2019</label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-group" hidden>
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="lodging" id="lodging1" value="IG" checked>
