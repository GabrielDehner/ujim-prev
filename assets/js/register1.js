$(function () { // Cuando el documento esta cargado.
    ...
    $('#name').blur(function () {
        if ($('#name').val().length > 0) {
            ...
            $('#name').next().removeClass('invalid-feedback').addClass('valid-feedback').html('Qué lindo nombre!');
        } else {
            $('#name').removeClass('is-valid').addClass('is-invalid');
            $('#name').next().removeClass('valid-feedback').addClass('invalid-feedback').html('mmm.. debés de tener un nombre!');
        }
    });
    ...
    $('#surname').blur(function () {
        if ($('#surname').val().length > 0) {
            ...
            $('#surname').next().removeClass('valid-feedback').addClass('invalid-feedback').html('Creo que falta algo acá..');
        }
    });
    ...
    $('#telephone').blur(function () {
        if ($('#telephone').val().length > 0) {
            ...
            $('#telephone').next().removeClass('invalid-feedback').addClass('valid-feedback').html('Con este número te vamos a comunicar el acceso a las reuniones.');
        } else {
            $('#telephone').removeClass('is-valid').addClass('is-invalid');
            $('#telephone').next().removeClass('valid-feedback').addClass('invalid-feedback').html('No tenés? Anotá el de un familiar o amigo!');
        }
    });
